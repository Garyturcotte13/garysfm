...
class SimpleFileManager(QMainWindow):
    ...
    # (Removed menu entry for 'Icon View: Use simple icons')
        ...
        # Theme submenu (named light color themes)
        if not hasattr(self, '_theme_menu_added'):
            theme_menu = view_menu.addMenu('Theme')
            self._theme_actions = {}
            for name in self.COLOR_THEMES.keys():
                ...
                try:
                    ...
                    # Rounded rect inset by 1px for a soft border
                    ...
                    pass
                a.triggered.connect(lambda checked, n=name: self.set_color_theme(n))
    ...
    def show_about_dialog(self):
        ...
        about_lines = [
            "Gary's File Manager",
            "Version 1.2.0 - UI polish, theme previews, verbosity controls, and context menu improvements",
