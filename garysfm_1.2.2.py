...
class SimpleFileManager(QMainWindow):
    ...
    def __init__(self):
        ...
        self.COLOR_THEMES = {
            # --- Midway regular color themes (blends of adjacent regular themes) ---
            'Blue Sand': {
                # Midpoint of Soft Blue + Warm Sand
                'window_bg': '#faf4fa', 'panel_bg': '#f6f1ea', 'text': '#222f32', 'accent': '#9e8a9f'
            },
            'Mint Gum': {
                # Midpoint of Mint + Gum
                'window_bg': '#f5faf7', 'panel_bg': '#f5f7f1', 'text': '#22191a', 'accent': '#a46a61'
            },
            'Grape Orange': {
                # Midpoint of Grape + Orange
                'window_bg': '#fdf8fa', 'panel_bg': '#f7f0ef', 'text': '#2b121b', 'accent': '#b87b93'
            },
            'Foggy Pastel': {
                # Midpoint of Foggy Grey + Pastel Green
                'window_bg': '#f1f7fa', 'panel_bg': '#e7f0f1', 'text': '#444a47', 'accent': '#899ba1'
            },
            'Lavender Peach': {
                # Midpoint of Lavender Mist + Peach Cream
                'window_bg': '#faf7f7', 'panel_bg': '#f7eef1', 'text': '#4d4a4a', 'accent': '#d6a4b6'
            },
            'Default Light': {
            ...
            'Red White Blue': {
                # Patriotic theme: white background, blue panel, red accent
                'window_bg': '#ffffff',
                'panel_bg': '#0033a0',
                'text': '#000000',
                'accent': '#d80027'
            ...
            'Orange White Green': {
                # Irish-inspired theme: white background, green panel, orange accent
                'window_bg': '#ffffff',
                'panel_bg': '#228b22',
                'text': '#000000',
                'accent': '#ff6600'
            ...
            'Lemon Pie': {
                # Bright and cheerful yellow theme with warm accents
                'window_bg': '#fffef0',
                'panel_bg': '#fff5b7',
                'text': '#2b2400',
                'accent': '#ffb84d'
        ...
        self.DARK_COLOR_THEMES = {
            ...
            'Red White Blue': {
                # Patriotic dark: deep blue background, white text, red accent
                'window_bg': '#001a33',
                'panel_bg': '#002855',
                'text': '#ffffff',
                'accent': '#ff1744'
            ...
            'Red White Black': {
                # Bold dark contrast: black background, dark gray panel, red accent
                'window_bg': '#000000',
                'panel_bg': '#1a1a1a',
                'text': '#ffffff',
                'accent': '#ff3030'
            ...
            'Orange White Green': {
                # Irish dark: deep green background, white text, orange accent
                'window_bg': '#001a00',
                'panel_bg': '#004400',
                'text': '#ffffff',
                'accent': '#ff8833'
        ...
        self.STRONG_COLOR_THEMES = {
            ...
            ,
            'Red White Blue': {
                # Strong patriotic: bold blue, white, and red
                'window_bg': '#001a33',
                'panel_bg': '#0033a0',
                'text': '#ffffff',
                'accent': '#ff1744'
            ...
            'Red White Black': {
                # Strong contrast: pure black background, red accent
                'window_bg': '#000000',
                'panel_bg': '#330000',
                'text': '#ffffff',
                'accent': '#ff0000'
            ...
            'Orange White Green': {
                # Strong Irish: pure black background, vibrant green panel, bright orange accent
                'window_bg': '#000000',
                'panel_bg': '#006600',
                'text': '#ffffff',
                'accent': '#ff4400'
            },
            # --- Midpoint strong color themes (blends of adjacent themes) ---
            'Vivid Lime': {
                # Midpoint of Vivid Sunset + Electric Lime
                'window_bg': '#110802', 'panel_bg': '#181303', 'text': '#e6e7d6', 'accent': '#b37f00'
            },
            'Lime Violet': {
                # Midpoint of Electric Lime + Neon Violet
                'window_bg': '#0c090b', 'panel_bg': '#100c1b', 'text': '#e6f87d', 'accent': '#669f80'
            },
            'Violet Indigo': {
                # Midpoint of Neon Violet + Royal Indigo
                'window_bg': '#09000f', 'panel_bg': '#10001f', 'text': '#c7f87f', 'accent': '#6288ff'
            },
            'Indigo Crimson': {
                # Midpoint of Royal Indigo + Crimson Royale
                'window_bg': '#110019', 'panel_bg': '#201030', 'text': '#f0e8f7', 'accent': '#8044aa'
            },
            'Crimson Violet': {
                # Midpoint of Crimson Royale + Deep Violet
                'window_bg': '#190017', 'panel_bg': '#300030', 'text': '#f8e0fa', 'accent': '#8840aa'
            },
            'Cyan Dream': {
                # Strong cyan-based theme
                'window_bg': '#002f36',
                'panel_bg': '#00bcd4',
                'text': '#e0fcff',
                'accent': '#00fff7'
            ...
            'Watermelon Strong': {
                # Bold watermelon colors with high contrast
                'window_bg': '#fe40ab',
                'panel_bg': '#006600',
                'text': '#d9f9ff',
                'accent': '#00ff00'
        ...
        self.SUBDUED_COLOR_THEMES = {
            # --- Midway subdued color themes (blends of adjacent subdued themes) ---
            'Gold Sand': {
                # Midpoint of Muted Gold + itself (since only one exists, just a variant)
                'window_bg': '#f7f6f2',
                'panel_bg': '#f6f2e7',
                'text': '#5a5748',
                'accent': '#b8a558'
            ...
            'Red White Black': {
                # Subdued contrast: light gray background, muted black panel, soft red accent
                'window_bg': '#f8f8f8',
                'panel_bg': '#e0e0e0',
                'text': '#333333',
                'accent': '#8b4444'
            ...
            'Orange White Green': {
                # Subdued Irish: light cream background, muted green panel, soft orange accent
                'window_bg': '#f9f9f7',
                'panel_bg': '#e8f0e8',
                'text': '#2d3d2d',
                'accent': '#cc7744'
        ...
        self.STRONG_THEME_MAP = {
            ...
            'Orange White Green': 'Orange White Green'
        }
    ...
    # (Removed menu entry for 'Icon View: Use simple icons')
        ...
        if not hasattr(self, '_theme_menu_added'):
            ...
            # Add Theme Color Customization action
            ...
            theme_menu.addAction(theme_customize_action)
    ...
    def open_theme_color_customization(self):
        ...
        def update_all_controls():
            ...
            current_theme_data.update({
                ...
                'border_radius': theme.get('border_radius', 3),
                'border_style': theme.get('border_style', 'solid'),
                'padding': theme.get('padding', 5),
                'margin': theme.get('margin', 2),
                'font_size': theme.get('font_size', 9),
                'font_weight': theme.get('font_weight', 'normal'),
                'font_family': theme.get('font_family', 'default'),
                'opacity': theme.get('opacity', 100),
                'shadow_enabled': theme.get('shadow_enabled', False),
                'shadow_blur': theme.get('shadow_blur', 5),
                'shadow_offset': theme.get('shadow_offset', 2),
            })
            
            # Update controls
            border_width_spin.setValue(current_theme_data['border_width'])
            border_radius_spin.setValue(current_theme_data['border_radius'])
            border_style_combo.setCurrentText(current_theme_data['border_style'])
            padding_spin.setValue(current_theme_data['padding'])
            margin_spin.setValue(current_theme_data['margin'])
            font_size_spin.setValue(current_theme_data['font_size'])
            font_weight_combo.setCurrentText(current_theme_data['font_weight'])
            font_family_combo.setCurrentText(current_theme_data['font_family'])
            opacity_slider.setValue(current_theme_data['opacity'])
            shadow_checkbox.setChecked(current_theme_data['shadow_enabled'])
            shadow_blur_spin.setValue(current_theme_data['shadow_blur'])
            shadow_offset_spin.setValue(current_theme_data['shadow_offset'])
        ...
        def save_theme():
            ...
            # Auto-generate variants for other theme types (simplified for extended properties)
            if hasattr(self, 'SUBDUED_COLOR_THEMES') and new_name not in self.SUBDUED_COLOR_THEMES:
                subdued_variant = current_theme_data.copy()
                # Reduce opacity for subdued effect
                subdued_variant['opacity'] = max(70, current_theme_data.get('opacity', 100) - 20)
                self.SUBDUED_COLOR_THEMES[new_name] = subdued_variant
            
            if hasattr(self, 'STRONG_COLOR_THEMES') and new_name not in self.STRONG_COLOR_THEMES:
                strong_variant = current_theme_data.copy()
                # Increase border width and enable shadow for strong effect
                strong_variant['border_width'] = min(5, current_theme_data.get('border_width', 1) + 1)
                strong_variant['shadow_enabled'] = True
                self.STRONG_COLOR_THEMES[new_name] = strong_variant
            
            # Also add to dark themes with auto-generated dark variant
            if hasattr(self, 'DARK_COLOR_THEMES'):
                # For now, just copy the color portion for dark variant generation
                color_only = {k: v for k, v in current_theme_data.items() if k in color_labels}
                dark_variant = self.generate_dark_variant(color_only)
                # Add the styling properties to dark variant
                for k, v in current_theme_data.items():
                    if k not in color_labels:
                        dark_variant[k] = v
                self.DARK_COLOR_THEMES[new_name] = dark_variant
            
            QMessageBox.information(dlg, 'Success', f'Theme "{new_name}" saved successfully with advanced styling!')
    ...
    def save_custom_themes(self):
        ...
        try:
            ...
            # Find custom themes (those not in the original set)
            original_themes = {
                'Default Light', 'Soft Blue', 'Warm Sand', 'Mint', 'Gum', 'Grape', 'Orange',
                'Foggy Grey', 'Pastel Green', 'Lavender Mist', 'Peach Cream', 'Sunny Yellow',
                'Red White Blue', 'Cyan Dream', 'Blue Sand', 'Mint Gum', 'Grape Orange',
                'Foggy Pastel', 'Lavender Peach'
            }
    ...
    def get_themes_directory(self):
        ...
        themes_dir = os.path.join(script_dir, 'gsfmt')
        ...
        if not os.path.exists(themes_dir):
            try:
                ...
                # Fallback to script directory if we can't create gsfmt folder
                return script_dir
    ...
    def load_custom_themes(self):
        """Load custom themes from QSettings and .gsfmt files."""
        # First migrate any existing theme files to the new location
        self.migrate_existing_theme_files()
        
        # First load from QSettings (for backward compatibility)
        try:
            settings = QSettings('garysfm', 'garysfm')
            custom_themes_json = settings.value('custom_themes', '{}')
            
            import json
            custom_themes = json.loads(custom_themes_json)
            
            # Add custom themes to COLOR_THEMES
            for name, theme in custom_themes.items():
                self.COLOR_THEMES[name] = theme
                
                # Also create dark variant
                if hasattr(self, 'DARK_COLOR_THEMES'):
                    dark_variant = {}
                    for key, color in theme.items():
                        if key in ['window_bg', 'panel_bg']:
                            ...
                            dark_variant[key] = qc.name()
                    self.DARK_COLOR_THEMES[name] = dark_variant
        except Exception:
            pass
            
        # Now load from .gsfmt files in the current directory
                    ...
                    try:
                        ...
                        if isinstance(theme_data, dict):
                            if "theme_info" in theme_data and "theme_data" in theme_data:
                                ...
                                if self.validate_theme_colors(theme_colors):
                                    # Add to the appropriate theme list based on mode
    ...
    def refresh_theme_menu(self):
        ...
        for name in regular_names:
            ...
            # Create a small swatch icon for the theme
            try:
                accent = theme.get('accent') or theme.get('panel_bg') or '#888888'
                from PyQt5.QtGui import QPixmap, QPainter, QColor, QIcon, QPen, QBrush
                from PyQt5.QtCore import QRectF
                sw = QPixmap(16, 16)
                sw.fill(QColor(0, 0, 0, 0))  # Transparent
                painter = QPainter(sw)
                painter.setRenderHint(QPainter.Antialiasing)
            ...
            def make_regular_callback(theme_name):
                def _set_regular_theme():
                    try:
                        # Clear mode flags when selecting regular themes
                        self.subdued_mode = False
                        self.strong_mode = False
                        try:
                            settings = QSettings('garysfm', 'garysfm')
                        ...
                        pass
                return _set_regular_theme
                
            a.triggered.connect(make_regular_callback(name))
            self.theme_menu.addAction(a)
            self._theme_actions[name] = a
            
        # Add separator before submenus
        sep2 = self.theme_menu.addSeparator()
        sep2._is_theme_action = True
        
        # Create ONE subdued themes submenu if themes exist
        subdued_names = sorted(self.SUBDUED_COLOR_THEMES.keys()) if hasattr(self, 'SUBDUED_COLOR_THEMES') else []
        if subdued_names:
            subdued_menu = self.theme_menu.addMenu('Subdued Themes')
        ...
        # Create ONE strong themes submenu if themes exist
        strong_names = sorted(self.STRONG_COLOR_THEMES.keys()) if hasattr(self, 'STRONG_COLOR_THEMES') else []
        if strong_names:
            strong_menu = self.theme_menu.addMenu('Strong Themes')
