...
Version: 1.0.7 - Drag-and-Drop to Browser Uploads (GitHub, etc.)

A cross-platform file manager built with PyQt5, supporting Windows, macOS, and Linux.


WHAT'S NEW IN 1.0.7 (August 2025):
...
class SimpleFileManager(QMainWindow):
    ...
    def show_about_dialog(self):
        ...
        about_lines = [
            "Gary's File Manager",
            "Version 1.0.7 - Folder Preview Compositing, ISO/Archive Thumbnails, and More",
            "Release: August 2025",
            "",
            "Announcement: This release adds enhanced folder preview compositing, ISO/archive thumbnails, improved drag & drop (multi-item), and faster local cut/paste moves (uses rename when possible).",
            "",
            "🌟 WHAT'S NEW IN 1.0.7:",
            ...
            "• Improved drag & drop: multi-item dragging and drop-onto-folder moves",
            "• Paste behavior: pasting into a single selected folder now uses that folder as destination",
            "• Faster local moves: cut/paste uses atomic rename (os.replace) when source and destination are on the same filesystem",
            ...
            "• Platform-specific handling for launching files with chosen apps",
            "• Improved cross-platform experience for 'Open with...'",
            "• Multiple view modes (Icon, List, Detail)",
