...
Version: 1.0.2 - Folder Preview Compositing, ISO/Archive Thumbnails, and More

A cross-platform file manager built with PyQt5, supporting Windows, macOS, and Linux.

WHAT'S NEW IN 1.0.2 (August 2025):
...
class SimpleFileManager(QMainWindow):
    ...
    def load_last_dir(self):
        try:
            if os.path.exists(self.SETTINGS_FILE):
                with open(self.SETTINGS_FILE, "r") as f:
                    ...
                    # Additional validation for macOS 11.0.2
        ...
        # Default fallback for macOS 11.0.2
        if sys.platform == 'darwin':
            return os.path.expanduser('~')
    ...
    def show_about_dialog(self):
        ...
        about_text += "🌟 WHAT'S NEW IN 1.0.2:\n"
