...
class ViewModeManager:
    ...
    def set_mode(self, mode):
        if mode in [self.THUMBNAIL_VIEW, self.LIST_VIEW, self.DETAIL_VIEW]:
...
class SimpleFileManager(QMainWindow):
    ...
    def show_about_dialog(self):
        ...
        about_lines = [
            "Gary's File Manager",
            "Version 1.0.9 - Enhanced Tabs, Menus, and Previews",
            "Release: August 2025",
            "",
            ...
            "",
            "🌟 WHAT'S NEW IN 1.0.9:",
            "• Thumbnail view renamed and improved (now the default view)",
            "• Added new thumbnail size options: 80, 160, 192, 224, 256",
            "• 'Open in New Tab' from folder right-click context menu",
            "• View menu deduplication and improved menu structure",
            "• Tools and Info menus restored and enhanced",
            "• Enhanced folder preview compositing (up to 4 thumbnails/icons)",
            "• ISO/archive thumbnails and robust fallback logic",
            "• Improved drag & drop: multi-item and drop-onto-folder moves",
            "• Paste into single selected folder uses that folder as destination",
            "• Faster local moves: cut/paste uses atomic rename when possible",
